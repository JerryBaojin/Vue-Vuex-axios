	...
	<body>
		...
		<section class="main">
			...
			<div class="ticket-btn">
				<!-- 交互方式： btn-white 将按钮设置为灰色 -->
				<a href="success.php" class="btn btn-green">立即领取</a>
			</div>
		</section>
		<!--交互方式：如果赠送的券暂时没有人领取 则添加class：hide -->
		<section class="leave-words">
			<div class="item-content flex-1">
				<strong>优惠券领取方式：</strong>
			</div>
			<div class="item-content flex-1">
				<strong>1、进入微信公众号“最内江”</strong>
			</div>
			<div class="item-content flex-1">
				<strong>2、点击页脚“评选活动”，进入领取美食大联盟专享优惠。</strong>
			</div>
		</section>
	</body>
	<?php
